import{j as e}from"./index-1D3tZeRU.js";import{S as t}from"./SyntaxHighlighter-7ip3ydM7.js";import{D as n}from"./DemoComponentApi-IiIr2ov9.js";import"./toConsumableArray-YYxflNc8.js";import"./objectWithoutPropertiesLoose-pdUxmcoj.js";import"./index-f0TC0RtX.js";import"./index.esm-1cw5D7XZ.js";import"./index-knWPyce5.js";const l=()=>e.jsxs(e.Fragment,{children:[e.jsxs("p",{children:["We form our navigation structure as array of objects & render it into UI eventually. You can change or customize the app navigation very easily by accessing"," ",e.jsx("code",{children:"src/configs/navigation.config/index.ts"})]}),e.jsx("p",{children:"Here is the type for a single menu item"}),e.jsx(t,{language:"ts",children:`interface NavigationTree {
    key: string;
    path: string;
