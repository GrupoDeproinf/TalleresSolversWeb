import{j as e}from"./index-nE3qTmWJ.js";import{S as o}from"./SyntaxHighlighter-WRXrPh9V.js";import{D as t}from"./DemoComponentApi-r_buyWw0.js";import"./toConsumableArray-YYxflNc8.js";import"./objectWithoutPropertiesLoose-pdUxmcoj.js";import"./index-qkYNi1s2.js";import"./index.esm-rJIJC5Wo.js";import"./index-D9LAS3yO.js";const u=()=>e.jsxs(e.Fragment,{children:[e.jsxs("p",{children:["Solvers use"," ",e.jsx("a",{href:"https://reactrouter.com/",target:"_blank",rel:"noopener noreferrer",children:"react-router"})," ","as base routing system. On this guide, you will find out how to create a new routes and how existing routes working."]}),e.jsxs("div",{className:"mt-6",id:"overview",children:[e.jsx("h5",{children:"Overview"}),e.jsxs("p",{className:"my-1",children:["You can find the template's router configuration in"," ",e.jsx("code",{children:"src/configs/routes.config/index.ts"}),", there's 2 type of route group as following."]}),e.jsx(o,{language:"js",children:`export const publicRoutes = [
    ...
]
...
]`})]}),e.jsxs("div",{className:"mt-10",id:"authority",children:[e.jsx("h5",{children:"Authority"}),e.jsxs("p",{className:"mt-1",children:["Solvers routes comes with a simple role based access control, you can set accessible roles as Array to"," ",e.jsx("code",{children:"authority"})," field. Taking following code as example, the route only available for user who have either"," ",e.jsx("code",{children:"'admin'"})," or ",e.jsx("code",{children:"'user'"})," in their profile.",e.jsx("br",{}),"If your leave ",e.jsx("code",{children:"authority"})," field as empty array, the route will open to any roles to access."]}),e.jsx(o,{language:"js",children:`export const protectedRoutes = [
    {
        ...
