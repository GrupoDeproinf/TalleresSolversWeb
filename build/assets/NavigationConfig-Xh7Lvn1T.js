import{j as e}from"./index-Nr7DOcs5.js";import{S as t}from"./SyntaxHighlighter-Lppmx1nC.js";import{D as n}from"./DemoComponentApi-6zRb4_DW.js";import"./toConsumableArray-YYxflNc8.js";import"./objectWithoutPropertiesLoose-pdUxmcoj.js";import"./index-NkYS5vPG.js";import"./index.esm-7QtrnPrk.js";import"./index-nftdwZx5.js";const l=()=>e.jsxs(e.Fragment,{children:[e.jsxs("p",{children:["We form our navigation structure as array of objects & render it into UI eventually. You can change or customize the app navigation very easily by accessing"," ",e.jsx("code",{children:"src/configs/navigation.config/index.ts"})]}),e.jsx("p",{children:"Here is the type for a single menu item"}),e.jsx(t,{language:"ts",children:`interface NavigationTree {
    key: string;
    path: string;
