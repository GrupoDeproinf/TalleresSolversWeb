import{j as e}from"./index-ABjXZzKD.js";import{S as t}from"./SyntaxHighlighter-KAsxxSPo.js";import{D as n}from"./DemoComponentApi-C2YupdIe.js";import"./toConsumableArray-YYxflNc8.js";import"./objectWithoutPropertiesLoose-pdUxmcoj.js";import"./index-hoI5MYke.js";import"./index.esm-G4kMKpK9.js";import"./index-Laf2x-F-.js";const l=()=>e.jsxs(e.Fragment,{children:[e.jsxs("p",{children:["We form our navigation structure as array of objects & render it into UI eventually. You can change or customize the app navigation very easily by accessing"," ",e.jsx("code",{children:"src/configs/navigation.config/index.ts"})]}),e.jsx("p",{children:"Here is the type for a single menu item"}),e.jsx(t,{language:"ts",children:`interface NavigationTree {
    key: string;
    path: string;
