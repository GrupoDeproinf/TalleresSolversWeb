import{j as e}from"./index-yOh4elUK.js";import{S as n}from"./SyntaxHighlighter-oOlKxWcZ.js";import"./toConsumableArray-YYxflNc8.js";import"./objectWithoutPropertiesLoose-pdUxmcoj.js";const o=()=>e.jsxs(e.Fragment,{children:[e.jsxs("p",{children:["Solvers use"," ",e.jsx("a",{href:"https://react.i18next.com/",target:"_blank",rel:"noopener noreferrer",children:"react-i18next"})," ","for internationalization, you can find corresponding files can be found in ",e.jsx("code",{children:"src/locales/*"})]}),e.jsxs("div",{className:"mt-10",id:"translatingText",children:[e.jsx("h5",{children:"Translating text"}),e.jsxs("p",{className:"mt-1",children:["One of the simplest usage for translate text is using"," ",e.jsx("code",{children:"useTranslate"})," hook provided by react-i18next."]}),e.jsx(n,{language:"tsx",children:`import { useTranslation } from 'react-i18next'
