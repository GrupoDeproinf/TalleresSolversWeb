    ...
    return (
        <>
            <div id="introduction" className="mb-8">
                <p>
                    Solvers is a complete React admin template with developer
                ...
                <p>
                    Solvers offers several themes and layout options that allow
                    you to update the style of your application in no time, it
                    also supports dark theme & multiple locales including RTL
                    languages.
                </p>
                <p>
                    Solvers has built-in working functionality pages, routing
            ...
            <div id="coreLibrary">
                ...
                <p>
                    Here is a list of some core libraries that we use in Solvers:
                </p>
                <ul>
                    <li>
                        <a
