...
const ServiceGarages = () => {
    ...
    const table = useReactTable({
        ...
        globalFilterFn: (row, _columnId, filterValue) => {
            ...
            const typeService = ((r as ServiceTemplate & { typeService?: string }).typeService ?? '').toLowerCase()
            return nombre.includes(term) || categoria.includes(term) || descripcion.includes(term) || typeService.includes(term)
        },
